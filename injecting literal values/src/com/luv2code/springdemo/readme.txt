...
The only difference in a setter dependency injection is that we are now passing the fortuneService Object into the setter method instead of constructor   